...
@pytest.mark.parametrize("brewery", ["0759476d-8fed-46cc-abec-1cb02cbca0d6", "189df38b-d6a6-40c0-917e-5b172be8d859",
                                     "2907b143-57b4-49ec-aa41-07df64d1e14b"])
def test_breweries_existence(breweries_api_user, brewery):
    breweries_response = breweries_api_user.get_data(brewery, '')
...
def test_breweries_existence(breweries_api_user, country):
...
def test_list_get_random_breweries(breweries_api_user):
    ...
    assert list_breweries_response.status_code == 200
